...
working_dir=/home/dmelgarm/RTGNSS/readi/mseed/2018/285/
net=RK
#Day needs to be one moreo if you want to run 10/12 it should be 10/13
start_time=2018-10-13T00:00:00Z
# Run it
...
# Run one day's worth of data through json2MSEED
sitelist=/home/dmelgarm/code/PANGA/site_list/readi_sitelist.txt
working_dir=/home/dmelgarm/RTGNSS/readi/mseed/2018/286/
net=RK
#Day needs to be one moreo if you want to run 10/12 it should be 10/13
...
# Run one day's worth of data through json2MSEED
sitelist=/home/dmelgarm/code/PANGA/site_list/readi_sitelist.txt
working_dir=/home/dmelgarm/RTGNSS/readi/mseed/2018/287/
net=RK
#Day needs to be one moreo if you want to run 10/12 it should be 10/13
